...
export default function StepCompute() {
  ...
  const computeComponents = cloudComponents.filter(
    (c) => c.cloud === cloud && c.category === 'compute'
  )

  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold tracking-tight">Compute</h2>
        <p className="text-muted-foreground mt-1">
          Selecteer de compute services voor je data platform.
        </p>
      </div>
